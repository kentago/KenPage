...
> **Syfte med detta dokument:** Om vi (Kenneth + en Claude-instans) någon gång
...
En personlig "kiosk-dashboard" för Kenneths hushåll i Kungsbacka, Sverige.
Körs på en surfplatta/skärm hemma och visar avgångar/reseplanering, väder,
...
**Språk:** Kenneth pratar svenska, all UI-text och kodkommentarer är på svenska
